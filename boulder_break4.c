...
// this one makes the move automatically, like snake does.
...
// My own part: delay (makes it move by itself, simlar to joystick controls)
char delay(char movee)
{
	...
	for(i=0; i<20000; i++)
	{
		// print for more efficient delaying
		printf("");
			
		// and check for keypresses
		if ( _kbhit() )
		{
...
// TASK TWO IS (maybe) WRONGGGGGGGGGGGGGGGGG
// THE ARRAY IS AN INT ARRAY
